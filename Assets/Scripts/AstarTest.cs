        ...
        if (player != null)
        {
            ...
            if (detectCol != null)
            {
                if (hit.collider != null)
                {
                    ...
                    if (hasLineOfSight)
                    {
                        Debug.DrawRay(monster.position, player.transform.position - monster.position, Color.green);
                    }
                    else
                    {
                        Debug.DrawRay(monster.position, player.transform.position - monster.position, Color.red);
                    }
                }
            }
        }
